...
/*
 * Starts the Android emulator workflow for local development  by resolving SDK tools,
 * booting a device when needed, and optionally launching Metro or Android app commands.
 */
...
function getSdkCandidates() {
  ...
  // Codex GPT-5: keep SDK discovery explicit so local emulator startup failures stay diagnosable.
  const candidates = [
