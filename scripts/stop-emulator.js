...
/*
 * Stops running Android emulator instances for local development  by locating adb and
 * issuing shutdown commands to each active emulator device.
 */
...
function resolveAdbPath() {
  // Codex GPT-5: prefer deterministic adb discovery so shutdown works across local SDK layouts.
