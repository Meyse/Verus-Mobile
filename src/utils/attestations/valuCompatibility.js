/*
 * Provides compatibility helpers for Valu attestation request and response formats  by
 * encoding, decoding, and validating request items and attestation payload structures.
 */
...
export class RequestItem {
  // Codex GPT-5: keep these numeric flags close to the model so wire-format validation stays explicit.
