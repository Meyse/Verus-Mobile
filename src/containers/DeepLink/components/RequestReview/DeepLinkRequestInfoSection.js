...
export const DeepLinkRequestInfoRow = ({label, selectable = true, value}) => {
...
const DeepLinkRequestInfoSection = ({rows = [], title}) => {
  const theme = useOnboardingTheme();
  const styles = useMemo(
    () => createDeepLinkRequestReviewStyles(theme),
    [theme],
...
export default DeepLinkRequestInfoSection;
