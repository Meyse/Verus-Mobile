...
const LegacyTabs = createMaterialBottomTabNavigator();

const LegacyHomeTabScreens = () => (
  <LegacyTabs.Navigator
    ...
    <LegacyTabs.Screen
      ...
      options={{
        title: 'Services',
        tabBarIcon: ({color}) => (
          <MaterialCommunityIcons name="room-service" color={color} size={26} />
        ),
      }}
    />
    <LegacyTabs.Screen
...
export default LegacyHomeTabScreens;
